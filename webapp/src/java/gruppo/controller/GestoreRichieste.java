...
import gruppo.controller.GestorePrenotazioneConferenza;
...
public class GestoreRichieste {
    ...
    public BeanRisposta gestioneRichieste(BeanCaratteristicheAula beanCaratteristiche, BeanSpecificheConferenza beanInfoTemporali) throws Exception {
        ...
        List<Aula> auleTmp = this.ricercaAulaConCaratteristiche(beanCaratteristiche, beanInfoTemporali);
    ...
    private List<Aula> ricercaAulaConCaratteristiche(BeanCaratteristicheAula beanCarAula, BeanSpecificheConferenza beanSpeConf) {
