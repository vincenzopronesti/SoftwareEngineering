...
public class UtenteDao {
    ...
    public static Utente findUtente(String username, String password) {
        ...
        try {
            ...
            // N.B. Le asserzioni andrebbero usate solo per testVerDisponibilita e debug, non per codice in produzione
